        ...
        <section id="comprar" className="container" style={{ paddingBottom: '4rem' }}>
          <div className="glass-card">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '3rem' }}>
              {/* Formular y Selección */}
              <div>
                <p style={{ marginBottom: '1.5rem', color: 'var(--text-light)', fontSize: '1.125rem' }}>
                  Por cada puesto de $10.000 tienes derecho a elegir <strong>4 números</strong> de 3 cifras. 
                </p>
